...
INSERT INTO login_cpanel VALUES('adminsql', 'untar1234', 'AdminSQL','adm03');
...
UPDATE time_table SET start_time = TO_TIMESTAMP ('2016-11-16 10:30', 'YYYY-MM-DD HH24:MI') , 
end_time = TO_TIMESTAMP ('2016-11-16 12:30', 'YYYY-MM-DD HH24:MI') ,
activate_time = TO_TIMESTAMP ('2016-11-16 00:00', 'YYYY-MM-DD HH24:MI');
commit;

UPDATE time_table SET start_time = TO_TIMESTAMP ('2016-11-16 03:30', 'YYYY-MM-DD HH24:MI') , 
end_time = TO_TIMESTAMP ('2016-11-16 12:00', 'YYYY-MM-DD HH24:MI') ,
...
Select * from login where name_code = 'sql-140';
select * from contestant;
